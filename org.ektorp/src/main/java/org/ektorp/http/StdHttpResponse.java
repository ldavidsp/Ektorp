...
public class StdHttpResponse implements HttpResponse {
    ...
    private org.apache.http.HttpResponse rsp = null;
	...
	public StdHttpResponse(org.apache.http.HttpResponse rsp, HttpEntity e, StatusLine status, HttpUriRequest httpRequest, Header eTagHeader) {
	    this.rsp = (rsp instanceof Closeable) ? rsp : null;
	...
	public void releaseConnection() {
		try {
			...
			if (rsp != null && rsp instanceof Closeable) {
                ((Closeable) rsp).close();
            }
		} catch (IOException e) {
			// ignore
